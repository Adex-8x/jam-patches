...
ORIGINAL_INSTRUCTION = 0xEB016C18
OFFSET_EU = 0x3430 # TODO
OFFSET_US = 0x3430
...
class PatchHandler(AbstractPatchHandler):
    ...
    @property
    def name(self) -> str:
        return 'KeepTrackOfFloor'

    @property
    def description(self) -> str:
        return "Updates the variable $CRYSTAL_COLOR_01 to keep track of the most recent floor the player has entered!"
