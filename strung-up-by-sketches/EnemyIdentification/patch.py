...
ORIGINAL_INSTRUCTION = 0xE28D1008
OFFSET_EU = 0x19B2C # TODO
OFFSET_US = 0x19B2C
...
class PatchHandler(AbstractPatchHandler):
    ...
    @property
    def name(self) -> str:
        return 'EnemyIdentification'

    @property
    def description(self) -> str:
        return "Talking to the partner will allow the player to identify adjacent enemies!"
