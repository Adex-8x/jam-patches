...
ORIGINAL_INSTRUCTION = 0xEA00009B
OFFSET_EU = 0xBD8C # TODO
OFFSET_US = 0xBD8C
...
class PatchHandler(AbstractPatchHandler):
    ...
    @property
    def name(self) -> str:
        return 'FlushGrayscale'

    @property
    def description(self) -> str:
        return "Implements a grayscale option for screen_FlushOut when the third parameter is above 0xB."
