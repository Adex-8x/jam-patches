...
ORIGINAL_INSTRUCTION = 0xEBF32AA1
OFFSET_EU = 0x68214
OFFSET_US = 0x68214
...
class PatchHandler(AbstractPatchHandler):
    ...
    @property
    def name(self) -> str:
        return 'DisableReviverReplacement'

    @property
    def description(self) -> str:
        return "If you already have an item within a Fixed Room, it will no longer be replaced with a Reviver Seed."
